...
@EnableJpaRepositories(basePackages = {"org.oursight.learning.spring.data.repository.jpa"})
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("org.oursight.learning.spring.data.entity");
